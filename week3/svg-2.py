...
def create_graph(lst1, lst2):
    ...
    line_chart.title = "Input/Output Unicast packets"
    line_chart.x_labels = [ str(i) for i in range(5, 65, 5) ] 
    line_chart.add('InUnicast', lst1)
    line_chart.add('OutUnicast', lst2)
    line_chart.render_to_file('output-2.svg')
...
in_octets_packets_total = int(get_oid(ip_tuple, user_tuple, oid="1.3.6.1.2.1.2.2.1.11.5")) # of type string, convert to int
out_octets_packets_total = int(get_oid(ip_tuple, user_tuple, oid="1.3.6.1.2.1.2.2.1.17.5"))

filename1 = "in-unicast-total.json"
filename2 = "out-unicast-total.json"
